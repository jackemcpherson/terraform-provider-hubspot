...
func propertyDefinitionAttrs(includeName bool) map[string]schema.Attribute {
	attrs := map[string]schema.Attribute{
		...
		"type":                   schema.StringAttribute{Computed: true, Description: "HubSpot storage type.", MarkdownDescription: "HubSpot storage type."},
		"field_type":             schema.StringAttribute{Computed: true, Description: "HubSpot editor field type.", MarkdownDescription: "HubSpot editor field type."},
		"description":            schema.StringAttribute{Computed: true, Description: "Property description.", MarkdownDescription: "Property description."},
		"display_order":          schema.Int64Attribute{Computed: true, Description: "HubSpot display order.", MarkdownDescription: "HubSpot display order."},
		"form_field":             schema.BoolAttribute{Computed: true, Description: "Whether the property can appear in forms.", MarkdownDescription: "Whether the property can appear in forms."},
		"hidden":                 schema.BoolAttribute{Computed: true, Description: "Whether HubSpot hides the property.", MarkdownDescription: "Whether HubSpot hides the property."},
		"has_unique_value":       schema.BoolAttribute{Computed: true, Description: "Whether values must be unique.", MarkdownDescription: "Whether values must be unique."},
		"external_options":       schema.BoolAttribute{Computed: true, Description: "Whether HubSpot, rather than this provider, owns the option set.", MarkdownDescription: "Whether HubSpot, rather than this provider, owns the option set."},
		"referenced_object_type": schema.StringAttribute{Computed: true, Description: "Referenced CRM object type, when this property references another object type.", MarkdownDescription: "Referenced CRM object type, when this property references another object type."},
		"show_currency_symbol":   schema.BoolAttribute{Computed: true, Description: "Whether HubSpot shows a currency symbol.", MarkdownDescription: "Whether HubSpot shows a currency symbol."},
		"calculation_formula":    schema.StringAttribute{Computed: true, Description: "HubSpot calculation formula, when this is a calculated property.", MarkdownDescription: "HubSpot calculation formula, when this is a calculated property."},
		"currency_property_name": schema.StringAttribute{Computed: true, Description: "Internal name of the currency source property, when applicable.", MarkdownDescription: "Internal name of the currency source property, when applicable."},
		"number_display_hint":    schema.StringAttribute{Computed: true, Description: "HubSpot number display hint.", MarkdownDescription: "HubSpot number display hint."},
		"text_display_hint":      schema.StringAttribute{Computed: true, Description: "HubSpot text display hint.", MarkdownDescription: "HubSpot text display hint."},
		"date_display_hint":      schema.StringAttribute{Computed: true, Description: "HubSpot date display hint.", MarkdownDescription: "HubSpot date display hint."},
		"sensitivity_category":   schema.StringAttribute{Computed: true, Description: "HubSpot data sensitivity category reported for this definition.", MarkdownDescription: "HubSpot data sensitivity category reported for this definition."},
		"calculated":             schema.BoolAttribute{Computed: true, Description: "Whether HubSpot calculates this property's value automatically.", MarkdownDescription: "Whether HubSpot calculates this property's value automatically."},
		"hubspot_defined":        schema.BoolAttribute{Computed: true, Description: "Whether HubSpot, rather than this provider, defines this property.", MarkdownDescription: "Whether HubSpot, rather than this provider, defines this property."},
		"is_archived":            schema.BoolAttribute{Computed: true, Description: "Whether this property definition is archived.", MarkdownDescription: "Whether this property definition is archived."},
		"archived_at":            schema.StringAttribute{Computed: true, Description: "Timestamp the property definition was archived, when applicable.", MarkdownDescription: "Timestamp the property definition was archived, when applicable."},
		"created_at":             schema.StringAttribute{Computed: true, Description: "Timestamp the property definition was created.", MarkdownDescription: "Timestamp the property definition was created."},
		"updated_at":             schema.StringAttribute{Computed: true, Description: "Timestamp the property definition was last updated.", MarkdownDescription: "Timestamp the property definition was last updated."},
		"created_user_id":        schema.StringAttribute{Computed: true, Description: "Identifier of the user who created the property definition.", MarkdownDescription: "Identifier of the user who created the property definition."},
		"updated_user_id":        schema.StringAttribute{Computed: true, Description: "Identifier of the user who last updated the property definition.", MarkdownDescription: "Identifier of the user who last updated the property definition."},
		"options":                schema.MapAttribute{Computed: true, Description: "Enumeration option set, keyed by immutable CRM record value.", MarkdownDescription: "Enumeration option set, keyed by immutable CRM record value.", ElementType: types.ObjectType{AttrTypes: optionAttrTypes()}},
		"modification_metadata":  schema.ObjectAttribute{Computed: true, Description: "HubSpot modification metadata describing what practitioners may change on this property.", MarkdownDescription: "HubSpot modification metadata describing what practitioners may change on this property.", AttributeTypes: metadataAttrTypes()},
	}
	if includeName {
		attrs["name"] = schema.StringAttribute{Required: true, Description: "Exact immutable property name.", MarkdownDescription: "Exact immutable property name.", Validators: []validator.String{identifierValidator{kind: "property name"}}}
	}
	return attrs
}

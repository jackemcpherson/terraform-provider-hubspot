...
v0.5 accepts only `data_sensitivity = "non_sensitive"`. Sensitive and
...
granular permissions, activation, deactivation, CRM user profiles, and global
identity deletion are deferred from this release.

...
`data_sensitivity = "non_sensitive"`. The v0.1 release excludes sensitive and
highly-sensitive definitions.
...
cannot become managed resources through import. Use the property-definition data
sources to inspect them.

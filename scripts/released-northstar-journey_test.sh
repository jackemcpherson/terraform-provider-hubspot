...
CALL_LOG="$log" HUBSPOT_DEMO_SCRIPT="$tmp/demo" "$root/scripts/released-northstar-journey.sh" v0.4.0
...
if CALL_LOG="$log" HUBSPOT_DEMO_SCRIPT="$tmp/demo" "$root/scripts/released-northstar-journey.sh" v0.3.0; then

...
for example in hubspot_property_group hubspot_property hubspot_form_definition; do
...
examples="provider property-definition property-group property aliases reference-hubspot_property_group reference-hubspot_property reference-hubspot_form_definition reference-hubspot_property_definition reference-hubspot_property_definitions"
...
check_examples() {
  ...
  for example in $examples; do
    ...
    case "$example" in
      property-group|property|aliases|reference-hubspot_property_group|reference-hubspot_property|reference-hubspot_form_definition)
